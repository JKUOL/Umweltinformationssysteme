...
ggplot(nor_long, aes(x = Time, y = Value, color = Type, group = Type)) +
  ...
  labs(title = "Normalized Oldenburg Data",
       ...
       y = "Concentration",
       color = "Data") +
  scale_color_manual(values = c("nor_NO2_Ol_2023" = "red", "nor_NO2_Ol_2019" = "green"))
```
...
This could be due to factors such as changes in traffic patterns, implementation 
of new air quality regulations, or variations in weather conditions.
...
ggplot(data_long, aes(x = Time, y = Value, color = Type)) +
  ...
  scale_color_manual(values = c("c(NO22) [ug/m^3] 2019" = "red", "c(NO22) [ug/m^3] 2023" = "green"))
```